...
const Front = (props:Iprops) => {
    ...
    const [content, setContent] = useState([
        {id:`1`,link:`https://www.youtube.com/watch?v=wmllZkygDLc&t=46s`,img:`dream.png`,title:`그림드림`,tags:[`html.png`,`css.png`,`semantic.png`,`javascript.png`,`jquery.png`,`java.png`,`springboot.png`,`jpa.png`,`oracle.png`],p:`아마추어 그림 작가들이 자신의 그림을 판매하는 플랫폼입니다.`},
