...
const Home = () => {
    const [major, setMajor] = useState([
        ...
        },
        {
            id: "1",
            pageY: undefined,
            h1: `Computer science Bachelor`,
            tags: ['인문학도', '개발자', '인턴경험', '복수전공'],
            p: `C언어 기반으로부터 공부를 시작을 하였고, 기초적인 전공지식과 정보처리기사를 바탕으로 CS지식을 습득하였습니다.`,
            cards: `place`,
            img: `sejong.png`,
            info: {
        ...
        },
        {
            id: "2",
            pageY: undefined,
            h1: `Bsidesoft Internship`,
            tags: ['인문학도', '개발자', '인턴경험', '복수전공'],
            p: `주로 Front와 QA를 진행을 하였고 대표적으로 코로나 백신 운반 프로젝트를 참여했습니다.`,
            cards: `place`,
            img: `bside.png`,
            info: {
                name: `bsidesoft`,
